...
<img width="191" height="528" alt="изображение" src="https://github.com/user-attachments/assets/a5205f6e-e2ca-48ae-9abc-f9812ee90ad1" />
...
В перспективе по аналогии с ним, реализуется сервис управления светом Light Control, для реаилзации "наблюдения" предлагается использовать внешнюю систему видеобнаблюдения на базе Ivideon через стандартные средства браузера. 
